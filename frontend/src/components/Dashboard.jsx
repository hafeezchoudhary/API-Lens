                            ...
                            return (
                                <div key={method}>
                                    ...
                                    <div className="w-full h-1.5 bg-zinc-800 rounded-full">
                                        <div
                                            className={`h-1.5 rounded-full ${colors[method]}`}
            ...
            <div className="border border-[#253244] bg-[#0E1827] rounded-xl mt-6">
                ...
                <div className="p-4">
                    ...
                    <div className="border border-[#253244] rounded-lg overflow-hidden">
                        ...
                        <div className="grid grid-cols-[90px_1fr_120px] px-4 py-3 bg-zinc-800/30 text-xs uppercase tracking-wider text-zinc-400">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <span
                                                className={`text-[11px] px-3 py-1 rounded-md border ${colors[endpoint.method]}`}
                                            >
                                                {endpoint.method}
                                            </span>
